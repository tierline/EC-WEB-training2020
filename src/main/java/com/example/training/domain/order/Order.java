...
import com.example.training.domain.member.Address;
import com.example.training.domain.member.Email;
import com.example.training.domain.member.FullName;
import com.example.training.domain.member.MemberId;
import com.example.training.domain.member.PhoneNumber;
