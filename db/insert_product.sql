...
INSERT ignore INTO members(email, last_name, first_name, password, postcode, prefecture, city, block, phone_number, last_updated_by, status)
VALUES("test@example.com", "坂本", "龍馬", "$2a$10$uhuqnvtjTayBhSjs7ezeB.2DG5GlIERAawzRoCROyTxWpzwKy7T.e", "655-0053", "兵庫県", "神戸市東灘区", "56番地", "078-555-5525", "none", "approval");
